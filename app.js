...
createApp({
    setup() {
        ...
        // Audio Effect for Add to Cart
        const cartAddSound = new Audio('https://cdn.pixabay.com/download/audio/2022/03/15/audio_19c10c689a.mp3?filename=interface-124464.mp3');
        cartAddSound.volume = 0.5; // Set volume to 50% to be less intrusive

        // Audio Effect for Remove from Cart
        const cartRemoveSound = new Audio('https://cdn.pixabay.com/download/audio/2022/03/10/audio_c8c8a73467.mp3?filename=whoosh-6316.mp3');
        cartRemoveSound.volume = 0.5;
        ...
        bgMusic.loop = true;
        bgMusic.volume = 0.1; // Subtle volume
        ...
        const triggerConfetti = () => {
            if (typeof confetti === 'function') {
                confetti({
                    ...
                    spread: 100,
                    origin: { y: 0.3 },
                    colors: ['#FF61D2', '#FE9090', '#FFD700', '#40E0D0', '#ffffff']
                });
            }
        };
        ...
        const addToCart = (product, size, color) => {
            // Play sound effect
            cartAddSound.currentTime = 0; // Rewind to start in case of rapid clicks
            cartAddSound.play();
        ...
        const removeFromCart = (index) => {
            cartRemoveSound.currentTime = 0;
            cartRemoveSound.play();
